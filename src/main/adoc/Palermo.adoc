...
:revnumber: W4109
:revdate: 2014-10-09
//:revremark: (Liste des équipements industriels): Présentation
:doctype: article
:lang: fr
:encoding: utf8
:toc:
...
* Mélanger les cartes **contrats publics**. Ensuite on révèle autant de
...
coût(s). On peut acheter 0, 1, 2, ou 3 carte(s), au choix du joueur.
...
Continuer jusqu'à ce que le joueur ait 3 cartes en main.
...
* Enchères inversées.
** Le premier joueur choisit une des cartes contrats visibles. (À moins
qu'il ne décide de passer.)
...
.2+| vrac: |1 gris + 1 jaune + 1 bleu + 1 blanc + 1 vert |5 M{beta}
|?

|1 jaune + 1 bleu + 1 blanc + 1 vert + 1 mauve |10 M{beta} |?

.7+| trié: |5 gris |10 M{beta} |?
...
|=======================================================================
.3+| Livraison{br}Vrac .3+| >{br}➃ .3+| Livraison{br}Trié
.3+| >{br}➂ .3+| Stockage |>{br}➁ |Décontamination

|>{br}➁ |Incinération

|>{br}➁ |Recyclage |>{br}➀ |Bourse
...
[cols=",,,,,,,",options="header",]
|=======================================================================
|cubes |ménagers{br}(gris) |papiers/cartons{br}(jaune)

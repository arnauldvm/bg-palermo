...
|=======================================================================
.3+| [Livraison]{br}Vrac .3+| ➃> .3+| [Livraison]{br}Trié .3+| ➂> .3+| Stockage
							|➁> | Décontamination     |    |
							|➁> | Incinération        |    |
							|➁> | Recyclage           | ➀> | Bourse
   | *v _(obligatoire)_*    |       | *v _(obligatoire)_*    |       | v _(optionnel)_
							|   | v v v _(optionnel)_ |    |
...
|=======================================================================
2+| papiers/cartons{br}(jaune) 2+| emballages{br}(bleu) 2+| verre{br}(blanc) 2+| végétaux{br}(vert)
...
[cols="8*^",options="header",]
|=======================================================================
|cubes | ménagers{br}(marron) | papiers/cartons{br}(jaune) | emballages{br}(bleu) | verre{br}(blanc) | végétaux{br}(vert)
